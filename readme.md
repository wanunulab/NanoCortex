...
> **Note:** You can find our example HeLa data @xxxxxncbi. And if you want to test our software quickly, please start with the subsampling bam file in example/data.
---
